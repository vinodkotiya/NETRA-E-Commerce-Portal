				...
				<div class="wrap-box" style="background: #fff; box-shadow: 2px 2px 5px 0px rgba(0,0,0,0.3);"><!--Start Box-->
					<div class="zerogrid">
						...
						<div class="row">
							<div class="col-2-3">
								<div class="wrap-col">
                                    <asp:TextBox ID="txtEmail" runat="server" placeholder="Enter Email" CssClass="caption" BorderStyle="inset"  ></asp:TextBox>
                                     <asp:Button ID="btnLoad" runat="server" Text="Register/Reload" CssClass="mybutton" />
								</div>
							</div>
							<div class="col-1-3">
								<div class="wrap-col">
