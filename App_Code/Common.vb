...
Public Class Common
    ...
    Public Shared Function makemenu(Optional ByVal sel As Integer = 1) As String
        ...
        If sel = 1 Then a1 = "class='active'"
        If sel = 2 Then a2 = "class='active'"
        If sel = 3 Then a3 = "class='active'"
        If sel = 4 Then a4 = "class='active'"
        If sel = 5 Then a5 = "class='active'"

        Dim temp = "	<ul>" &
                   "<li class='" & a1 & "'><a href='Default.aspx'>Home</a></li>" &
                 "  <li class='" & a2 & "'><a href='labs.aspx'>Labs</a></li>" &
                 "  <li class='" & a4 & "'><a href='report.aspx'>Report</a></li>" &
                  " <li class='" & a5 & "'><a href ='contact.aspx'>Contact</a></li>" &
                "</ul>"
    ...
    Public Shared Function getFooter() As String
        Return "<h3>Contact</h3>			<span>Phone / +91 120 999 99 9999 </span></br>				<span>Email / info@ntpc.co.in  </span></br>				<span>E-3, Ecotech II, Udyog Vihar, Ecotech-II, Udyog Vihar, Greater Noida, Uttar Pradesh 201306 </span></br>				<span>Copyright © 2018 NTPC Limited - Designed by <a href='https://cc.ntpc.co.in/ccit'>CC-IT, SCOPE</a></span>"
    End Function
End Class
